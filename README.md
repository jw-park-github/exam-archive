...
> 기존의 족보 공유 사이트들이 지닌 단점들을 보완하여 바쁜 시험 기간 동안 교내 학생<br>
> 들이 빠르고 편리하게 자료를 이용할 수 있도록 개발된 기출문제 공유 서비스입니다.<br>

## 1. 프로젝트 개요
<strong>ㆍ시행처</strong>: 서강대학교 컴퓨터 중앙동아리 [SGCC]<br>
<strong>ㆍ기간</strong>: 2022.03~2022.12<br>
<strong>ㆍ프로그래밍 언어</strong>: Python, HTML, CSS, JavaScript<br>
<strong>ㆍ프레임워크</strong>: Django<br>
<strong>ㆍ라이브러리</strong>: django-import-export, Magic-Grid, Bootstrap<br>
<strong>ㆍDBMS</strong>: MySQL, SQLite<br>
<strong>ㆍ1차 배포</strong>: AWS EC2, Docker<br>
<strong>ㆍ2차 배포</strong>: PythonAnywhere<br>
